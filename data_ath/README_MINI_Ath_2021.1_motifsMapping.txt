...
#promoter definition: 5000kb upstream TSS, 1000kb downstream TES. Introns were included in the regulatory regions, while coding exons were excluded. 
...
#GO annotation(MINI-EX): downloaded on September 2020 (http://geneontology.org/gene-associations/tair.gaf.gz). Biological Process (BP). GO evidence code: EXP, IMP, IDA, IPI, IGI, IEP, TAS, NAS, IC.