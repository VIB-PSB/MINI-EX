...
#GO annotation(MINI-EX): downloaded on October 2023 from PLAZA Monocots 5.0. Biological Process (BP) + all GO evidence codes. Obsolete ids discarded and replaced with new ids (when provided); alternate ids replaced with corresponding primary ids; parental terms propagated; duplicate annotations discarded.